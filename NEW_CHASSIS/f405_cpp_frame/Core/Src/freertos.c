...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of chssis_task */
  osThreadDef(chssis_task, Chassis_Task, osPriorityNormal, 0, 1024);
  chssis_taskHandle = osThreadCreate(osThread(chssis_task), NULL);
  ...
  osThreadDef(referee_task, Referee_Task, osPriorityNormal, 0, 514);
